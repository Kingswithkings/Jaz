...
export default function ParentDashboard() {
  ...
  useEffect(() => {
    ...
    api.get(`/parents/${parentId}/summary`)
      .then((res) => setChildren(res.data.children))
      .catch((err) => console.error(err));
  }, []);

  async function generateReport(childId: number, reportType: "daily" | "weekly") {
    const parentId = getParentId();
    ...
    window.open(`${process.env.NEXT_PUBLIC_API_URL}${res.data.download_url}`, "_blank");
  }
